    ...
    <div id="app">
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                <div class="position-relative sidebar-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('mazer/dist/assets/compiled/svg/logo.svg') }}"
                                    alt="Logo" srcset=""></a>
                        </div>
                        <div class="d-flex align-items-center gap-2 mt-2 theme-toggle">
                            ...
                            <div class="form-check form-switch fs-6">
                                <input class="me-0 form-check-input" type="checkbox" id="toggle-dark"
                        ...
                        <div class="sidebar-toggler x">
                            <a href="#" class="d-block sidebar-hide d-xl-none"><i
                            ...
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                                    <div class="px-4 py-4-5 card-body">
                                        <div class="row">
                                            <div
                                                class="d-flex justify-content-start col-md-4 col-lg-12 col-xl-12 col-xxl-5">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="d-flex align-items-center">
                                                    <svg class="text-primary bi" width="32" height="32"
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="d-flex align-items-center">
                                                    <svg class="text-success bi" width="32" height="32"
                                                        fill="blue" style="width:10px">
                                                        <use
                                                            xlink:href="{{ asset('mazer/dist/assets/static/images/bootstrap-icons.svg') }}#circle-fill" />
                                                    </svg>
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="d-flex align-items-center">
                                                    <svg class="text-danger bi" width="32" height="32"
                                                        fill="blue" style="width:10px">
                                                        <use
                                                            xlink:href="{{ asset('mazer/dist/assets/static/images/bootstrap-icons.svg') }}#circle-fill" />
                                                    </svg>
